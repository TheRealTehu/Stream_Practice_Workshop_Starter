    ...
    public List<Patient> listTopTenPatientsBasedOnPriorityScore() {
        ...
        return patients.stream()
                .sorted(Comparator.comparingDouble(p ->
                        p.getNumberOfLowPriorityProblems() * 0.9
                                + p.getNumberOfMediumPriorityProblems() * 1.1
                                + p.getNumberOfHighPriorityProblems() * 1.5).reversed()).limit(10).collect(Collectors.toList());
    }
}
